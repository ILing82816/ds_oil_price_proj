...
plt.title("de-trend of wti price monthly")
plt.plot(wti_oil_price_diff,color="blue",Label='wti_price_monthly_diff')
plt.legend()
plt.savefig('de-trend_wti_price_monthly.png')
plt.show()
...
plt.legend()
plt.savefig('ACF_PACF_wti_price_monthly.png')
plt.show()
...
plt.plot(actual_prediction, color="blue",Label='wti_price_prediction')
plt.legend()
plt.show()
